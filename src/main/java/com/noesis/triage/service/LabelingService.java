...
import com.noesis.triage.model.*;
import com.noesis.triage.model.webhook.GitHubIssue;
import com.noesis.triage.model.feign.Label;
import com.noesis.triage.model.webhook.GitHubLabel;
...
public class LabelingService {
    ...
    private String buildPrompt(GitHubIssue issue, List<Label> repositoryLabels, Map<String, IssueContext> repositoryIssuesByLabel) {
        ...
        promptBuilder.append("You are Noesis, an intelligent issue triage assistant. Read the following GitHub issue and return relevant labels.\n\n");
        ...
        if (repositoryLabels != null && !repositoryLabels.isEmpty()) {
            ...
            // Fallback to standard industry labels if repository has no labels defined
            promptBuilder.append("Available labels: ['bug', 'enhancement', 'feature', 'question', 'documentation', 'performance', 'security', 'regression', 'dependencies']\n\n");
        }
