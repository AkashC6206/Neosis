...
import com.noesis.triage.model.webhook.*;
...
class GitHubWebhookPayloadTest {
    ...
    void shouldParseWebhookPayloadFromJson() throws IOException {
        ...
        assertThat(issue.getHtmlUrl()).isEqualTo("https://github.com/a-TODO-rov/noesis/issues/2");
        ...
        assertThat(repository.getName()).isEqualTo("noesis");
        assertThat(repository.getFullName()).isEqualTo("a-TODO-rov/noesis");
